...
from feedagregatorlib.scaleentry import ScaleEntry


class OpacityFrame(ttk.Frame):
    def __init__(self, master=None, value=85, style='title.TLabel', **kw):
        ...
        self.opacity_scale.grid(row=0, column=1, padx=4, pady=4, sticky='ew')
